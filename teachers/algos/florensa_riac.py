    ...
    def assign_states_to_regions(self, region1, region2):
        ...
        for state, competence in zip(self.states, self.competences):
            if region1.contains(state):
                ...
                print("Region 1: " + str(region1.min_border) + " " + str(region1.max_border))
                print("Region 2: " + str(region2.min_border) + " " + str(region2.max_border))
...
class Florensa_RIAC(object):
    ...
    def update(self, state, competence, empty_jim):
        ...
        if region.is_too_big():
            ...
            if success:
                ...
                print('SPLIT FAILED, should not happen')
        return success, None
    ...
    def compute_all_interests(self):
        ...
        if sum_interests == 0:
            #print("All interests are " + str(min_interest))
