...
class GEP(object):
    ...
    def produce(self, normalized_goal=None, goal_space_name=None, bootstrap=False, context=None):
        ...
        if bootstrap:
            ...
            return current_policy, None, False, None
        ...
        logboy=False
        current_policy, add_noise, goal = self.modules[module_name].produce(self.policies, logboy=logboy)
        #print(self.current_policy.shape)
        return current_policy, module_outcome_range, add_noise, goal
