from param_env_utils.imgep_utils.gep_utils import Bounds

#EMMC CONFIG
EMMC_B = Bounds()
EMMC_B.add('agent_x', [288.3, 294.7])
EMMC_B.add('agent_z', [431.3, 443.7])
EMMC_B.add('pickaxe_x', [288.3, 294.7])
EMMC_B.add('pickaxe_z', [431.3, 443.7])
EMMC_B.add('shovel_x', [288.3, 294.7])
EMMC_B.add('shovel_z', [431.3, 443.7])
for i in range(5):
...
# ARMB_B.add('arm_0', [-1.,1.])
# ARMB_B.add('arm_1', [-1.,1.])
# ARMB_B.add('arm_2', [-1.,1.])
# ARMB_OBJECTS = [['arm_0', 'arm_1', 'arm_2']]
# ARMB_OBJECTS_IDX = [[0,3]]
ARMB_B.add('arm_x', [-4.,4.])
ARMB_B.add('arm_y', [-4.,4.])
ARMB_OBJECTS = [['arm_x', 'arm_y']]
ARMB_OBJECTS_IDX = [[0,2]]
...
def get_objects(name):
    if name == 'emmc_env':
        ...
        return ARMB_OBJECTS, ARMB_OBJECTS_IDX
    else:
        print('UNKNOWN ENV')
